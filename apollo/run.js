...
// //Query
graphql(graphqlClient, query).subscribe((data) => {
    console.log("query", data.data);
}, console.error.bind(this), () => console.log("query done"));

// Live Query
graphql(graphqlClient, query, "live").subscribe((data) => {
    console.log("live", data.data);
}, console.error.bind(this), () => console.log("live done"));
...
}, console.error.bind(this), () => console.log("subscribe done"));
